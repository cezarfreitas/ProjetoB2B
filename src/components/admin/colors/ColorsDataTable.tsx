...
export default function ColorsDataTable({
  ...
  const columns = React.useMemo<ColumnDef<Color>[]>(() => [
    {
      accessorKey: 'id',
      header: ({ column }) => {
        return (
    ...
    },
    {
      ...
      cell: ({ row }) => {
        const hexCode = row.getValue('hexCode') as string | null
        return (
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Tem certeza que deseja excluir a cor "{color.name}"? 
    ...
    <div className="w-full space-y-3">
      ...
      <div className="flex items-center justify-between py-3 px-1">
        <div className="flex-1 text-sm text-gray-600">
          {table.getFilteredRowModel().rows.length} cor(es) encontrada(s).
        </div>
